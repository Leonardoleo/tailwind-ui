								...
								>
									...
									>
										...
										>
											...
											>
												<a
													v-for="solution in header.solutions"
													:key="solution.name"
													:href="solution.href"
													class="
														-m-3
											...
											>
												<div
													v-for="cta in header.callsToAction"
													:key="cta.name"
													class="flow-root"
												>
													<a
								...
								>
									...
									>
										...
										>
											...
											>
												<a
													v-for="resource in header.resources"
													:key="resource.name"
													:href="resource.href"
													class="
														-m-3
											...
											<div class="px-5 py-5 bg-gray-50 sm:px-8 sm:py-8">
												<div>
													...
													<ul role="list" class="mt-4 space-y-4">
														<li
															v-for="post in header.recentPosts"
															:key="post.name"
